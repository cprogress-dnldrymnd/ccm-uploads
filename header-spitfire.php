...
<head>
  ...
  <meta name="theme-color" content="#ed181f">
...
<!-- end webpush tracking code -->
  <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=265318043901425&ev=PageView&noscript=1"
    /></noscript>
...
.mega-menu-col .navbar-nav li .mega-menu .megamenu-breadcrumb a:active {
  color: #dc3524;
	...
	header {
		padding-bottom: 40px;
		background: transparent linear-gradient(180deg, #181818 0%, #18181800 100%) 0% 0% no-repeat padding-box;
  ...
  <!--[if lt IE 9]>
      ...
      <![endif]-->
        ...
        <header class="header-page-components clear">
          <a class="logo-page-components" ><img src="https://www.ccm-motorcycles.com/wp-content/uploads/2018/02/logo.png" class="img-responsive"></a>
