...
function login() {
	...
	/*$menu.insertBefore('.woocommerce-account .the-content >.woocommerce #customer_login');*/
}
...
function moveRegisterItems(){
	...
	/*$('.ownership').insertAfter('.woocommerce-form-register >.acf-fields .acf-field[data-name="bike_information"]');
	*/
}
...
/*function registerPasswordValidate() {
	$password = $('.password_xx input').val();
	$confirm = $('.confirm_password_xx input').val();
	...
	$( ".woocommerce-form-register" ).submit(function( event ) {
		if ($password != $confirm) {
			...
			console.log($confirm);
			event.preventDefault();
			$('password_xx input').css('background-color', 'red');
			$('confirm_password_xx input').css('background-color', 'red');
		}
		else {
			$('password_xx input').css('background-color', 'green');
			$('confirm_password_xx input').css('background-color', 'green');
		}
