...
<main class="news careers page-template-page-owners events-main club-main">
    <?php if ( have_posts() ) { ?>
        <?php while ( have_posts() ) { ?>
            ...
            ?>
              <!--   <section class="sp-banner" style="background-image: url(<?php echo $thumb; ?>)">
            ...
            <section class="back text-center">
                <div class="container tight width1116">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <a class="btn ghost-btn red-b" href="http://www.ccm-motorcycles.com/updates/">BACK TO UPDATES</a>
                        </div>
                    </div>
                </div>
            </section>
