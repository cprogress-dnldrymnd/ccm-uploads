  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="caption">
          <h1>RAF BENEVOLENT FUND SPITFIRE</h1>
        ...
        <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2018/07/raf-sub.jpg">
      </div>
    </div>
  </div>
                      ...
                      <div class="boxes">
                        <div class="row">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                              ...
                              <label for="box-4">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-222" value="96.00">
                                <label for="box-222">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-333" value="199.00">
                              <label for="box-333">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                        ...
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-29" value="30.00">
                                <label for="box-29">
                                  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
  	...
  	<div class="container">
  		<div class="row">
  			...
  			<div class="col-md-7 ">
  				...
  				<p>Simply this form to send your desired bike configuration to us and we'll contact you about placing your order. There'll still be time to change your configuration and we'll go through all of the options with you in case you've missed something.</p>
  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-md-2 col-sm-2 hidden-xs">
  				<img src="https://www.ccm-motorcycles.com/wp-content/uploads/2020/02/raf-01.png">
  			</div>
  			...
  			<div class="col-md-3 col-sm-3 ">
  				<a href="#reserve_bike" class="red-btn pull-right scroll-down">ORDER MY BIKE</a>
  			</div>
  		</div>	
  	</div>
  </div>
