  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="caption">
          <h1 class="bike-name">SPITFIRE BOBBER</h1>
        ...
        <img src="/wp-content/uploads/2020/02/bobber-sub-new.jpg"  class="first_image">
      </div>
    </div>
  </div>
                    ...
                    <div class="boxes">
                      <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                         ...
                         <label for="box-1s">
                          <img src="/wp-content/uploads/2020/02/stealth-bobber-sml.png">
                          <h4>Stealth Kit</h4>
                          
                          <ul>
                            <li>Bronze Chrome Frame Kit Titanium Anodized Billeted Parts Kit&nbsp;</li>
                            ...
                            <li>Wheels with Black Rims + Stainless Steel Spokes &nbsp;</li>
                          </ul>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                  ...
                                  <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                      ...
                                      <div class="row"> 
                                        <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                          <input class="tot_amount" type="checkbox" id="box-206a" value="0.00">
                                          <label for="box-206a">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                                            <h4>Black Walled Tyres</h4>
                                            <span class="d-block">Part No. 110001</span>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                  ...
                                  <div class="row"> 
                                    <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                                      ...
                                      <label for="box-12a">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                   ...
                   <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      ...
                      <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                       ...
                       <label for="box-10c">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                          ...
                          <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                              ...
                              <label for="box-24a">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/032b.jpg">
                                <h4>Billeted Adjustable Front Brake and Clutch Levers</h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-2 col-sm-2 hidden-xs">
            <img src="/wp-content/uploads/2020/02/bobber-standard-sub-new.jpg">
          </div>
          <div class="col-md-7 col-sm-7 title-pro">
            <h2>SPITFIRE BOBBER</h2>
...
function updatesummary() {
  ...
  special_equipment = handlebar_options = performance= weather = leather = billet_aluminium = security = oil_filler_caps = fuel_tank = seat_trim = carbon_fibre = stealth_kit = 0;
  ...
  $(selector).each(function() {
    ...
    if (catgoryname.indexOf('stealth_kit') != -1){
    ...
    } else if(catgoryname.indexOf('special_equipment') != -1){
...
$('.stealth_kit input').change(function(){
 if($('#box-1s,#box-1s2').is(":checked")) {
   $('.first_image').attr('src','/wp-content/uploads/2020/02/bobber-sub.jpg');
   $('.footer-order img').attr('src','/wp-content/uploads/2020/02/bobber-sml.jpg');
 } else {
  
   $('.first_image').attr('src','https://www.ccm-motorcycles.com/wp-content/uploads/2020/02/bobber-sub-new.jpg');
   $('.footer-order img').attr('src','https://www.ccm-motorcycles.com/wp-content/uploads/2020/02/bobber-standard-sub-new.jpg');
