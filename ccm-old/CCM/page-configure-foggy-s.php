  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="caption">
          <h1 class="bike-name">FOGGY S EDITION SPITFIRE</h1>
        ...
        <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2020/02/foggy-s-big.jpg">
      </div>
    </div>
  </div>
              ...
              <div id="se" class="panel-collapse collapse in">
                <div class="container">
                      ...
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a1" value="1500.00">
                                <label for="box-a1">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/WW11-Spitfire-Fuselage-360x360.jpg">
                                  <h4>GENUINE PIECE OF WW2 SPITFIRE FUSELAGE MOUNTED AS A PLATE ON BAR CLAMPS (ADD-ON)</h4>
                                  <span class="d-block">Part No. 500056</span>
                                  <span class="price">£1500.00</span>
                              </label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a2" value="119.00">
                                <label for="box-a2">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/001-360x360.jpg">
                                  <h4>SMOKED FLY SCREEN (ADD-ON)</h4>
                                  <span class="d-block">Part No. S6F09C01816</span>
                                  <span class="price">£119.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a3" value="30.00">
                              <label for="box-a3">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/007-360x360.jpg">
                                <h4>CLUTCH COVER VINYL SPITFIRE BADGE (ADD-ON)</h4>
                                <span class="d-block">Part No. 100002</span>
                                <span class="price">£30.00</span></label>

                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                              <input class="tot_amount" type="checkbox" id="box-a4" value="30.00">
                              <label for="box-a4">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/003-360x360.jpg">
                                <h4>LH ENGINE CASE BADGE (ADD-ON)</h4>
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a5" value="150.00">
                                <label for="box-a5">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/004-360x360.jpg">
                                  <h4>CIRCULAR BAR END MIRRORS (BILLITED) (ORIGINAL INCLUDED)</h4>
                                  <span class="d-block">Part No. S6F09C01701</span>
                                  <span class="price">£150.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a6" value="80.00">
                              <label for="box-a6">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/006-360x360.jpg">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a7" value="88.00">
                              <label for="box-a7">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/007-360x360.jpg">
                         ...
                         <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a8" value="799.00">
                              <label for="box-a8">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/047a-360x360.jpg">
                                <h4>CCM NUMBERED DISPLAY STAND (ADD-ON)</h4>
                                <span class="d-block">Part No. </span>
                                <span class="price">£799.00</span></label>
                          </div> 
                          </div> 
                          <div class="row">
                        
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a9" value="99.00">
                                <label for="box-a9">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/009-360x360.jpg">
                                  <h4>SIDE MOUNTED NUMBER PLATE HOLDER (ORIGINAL INCLUDED)</h4>
                                  <span class="d-block">Part No. S6F09C01701</span>
                   ...
                   <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a10" value="4950.00">
                                <label for="box-a10">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/045-360x360.jpg">
                                  <h4>OHLINS RACE PACK (REPLACE STANDARD)</h4>
                                  <span class="d-block">Part No. 500078</span>
                                  <span class="price">£4950.00</span>
                              </label>
                          </div>  
                          
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a11" value="899.00" >
                                <label for="box-a11">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/019-360x360.jpg">
                                  <h4>OHLINS REAR SHOCK (REPLACE STANDARD)</h4>
                 ...
                 <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a12" value="40.00">
                                <label for="box-a12">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/025-360x360.jpg">
                                  <h4>TAN LEATHER GRIP WRAP (ADD-ON)</h4>
                                  <span class="d-block">Part No. S6F08C01014</span>
                                  <span class="price">£40.00</span>
                              </label>
                          </div>  
                           <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a13" value="159.00" >
                                <label for="box-a13">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/014-360x360.jpg">
                                  <h4>TAN LEATHER TANK STRAP (ADD-ON)</h4>
                                  <span class="d-block">Part No. 500086</span>
                                  <span class="price">£159.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a14" value="29.00">
                              <label for="box-a14">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/026-360x360.jpg">
                                <h4>TAN LEATHER WALLET (ADD-ON)</h4>
                                <span class="d-block">Part No. S6F09C01815</span>
                                <span class="price">£29.00</span></label>
                   ...
                   <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a15" value="257.00">
                                <label for="box-a15">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/Billet-Footpeg-Conversion-Kit-360x360.jpg">
                                  <h4>BILLET FOOTPEG CONVERSION KIT (AS SEEN ON SPITFIRE) </h4>
                                  <span class="d-block">Part No. 500057</span>
                                  <span class="price">£257.00</span>
                              </label>
                          </div>  
                         <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a16" value="55.00" >
                                <label for="box-a16">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/027-360x360.jpg">
                                  <h4>BILLETED SWINGARM TORQUE BLOCK (REPLACE STANDARD)</h4>
                                  <span class="d-block">Part No. S6F13C01018</span>
                                  <span class="price">£55.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a17" value="89.00">
                              <label for="box-a17">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/029-360x360.jpg">
                                <h4>BILLETED CLUTCH MASTER CYLINDER COVER (REPLACE STANDARD)</h4>
                                <span class="d-block">Part No. S6F09C01830</span>
                                <span class="price">£89.00</span></label>

                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                              <input class="tot_amount" type="checkbox" id="box-a18" value="250.00">
                              <label for="box-a18">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/030-360x360.jpg">
                                <h4>BILLETED GEAR LEVER + REAR BRAKE LEVER (ORIGINAL INCLUDED)</h4>
                        ...
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a19" value="75.00">
                                <label for="box-a19">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/031-360x360.jpg">
                                  <h4>BILLETED SPROCKET COVER (ADD-ON) </h4>
                                  <span class="d-block">Part No. 500068</span>
                                  <span class="price">£75.00</span>
                              </label>
                          </div>  
                         <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a20" value="150.00" >
                                <label for="box-a20">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/032b-360x360.jpg">
                                  <h4>BILLETED ADJUSTABLE FRONT BRAKE + CLUTCH LEVER (ORIGINAL INCLUDED)</h4>
                                  <span class="d-block">Part No. 500051</span>
                                  <span class="price">£150.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a21" value="110.00">
                              <label for="box-a21">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/033-360x360.jpg">
                                <h4>BILLETED CLUTCH SLAVE CYLINDER (REPLACE STANDARD)</h4>
                 ...
                 <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a22" value="99.00">
                                <label for="box-a22">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/021-360x360.jpg">
                                  <h4>CARBON CHAIN GUARD (ADD-ON)</h4>
                                  <span class="d-block">Part No. 500047</span>
                                  <span class="price">£99.00</span>
                              </label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-a23" value="49.00" >
                                <label for="box-a23">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/022-360x360.jpg">
                                  <h4>CARBON REAR MASTER CYLINDER COVER (ADD-ON)</h4>
                                  <span class="d-block">Part No. S6F09C01103</span>
                                  <span class="price">£49.00</span></label>
                          </div>  
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-a24" value="349.00">
                              <label for="box-a24">  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/041-360x360.jpg">
                                <h4>CARBON ENGINE COVERS (L+R) (ADD-ON)</h4>
                   ...
                   <div class="container">
                    <div class="panel-body px-0 py-5 ">
                      <div class="boxes">
                        <div class="row">
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                             <input class="tot_amount" type="checkbox" id="box-a25" value="2000.00">
                                <label for="box-a25">
                                  <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2019/11/044-360x360.jpg">
                                  <h4>AUSTIN RACING TITANIUM UNDERSEAT EXHAUST SYSTEM (ORIGINAL INCLUDED)</h4>
                                  <span class="d-block">Part No. 500016</span>
                                  <span class="price">£2000.00</span>
                              </label>
                          </div>  
                          <!--<div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                               <input class="tot_amount" type="checkbox" id="box-30" value="30.00" >
                                <label for="box-30">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                            <input class="tot_amount" type="checkbox" id="box-31" value="30.00">
                              <label for="box-31">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
                          ...
                          <div class="col-md-3 col-sm-6 col-xs-6 mb-30">
                              ...
                              <label for="box-32">  <img src="/wp-content/uploads/2020/02/no-image-ccm.png">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-sm-2 hidden-xs">
          <img src="https://www.ccm-motorcycles.com/wp-content/uploads/2020/02/foggy-s-small.jpg">
        </div>
        <div class="col-md-7 col-sm-7 title-pro">
          <h2>FOGGY S EDITION SPITFIRE</h2>
...
$("#box-a10").click(function(){
  $("#box-a11").prop("checked", false);
 
 })

$("#box-a11").click(function(){
  $("#box-a10").prop("checked", false);
...
$("#box-32").click(function(){
  ...
  function updatesummary() {
    ...
    special_equipment = handlebar_options = performance= weather = leather = billet_aluminium = security = oil_filler_caps = fuel_tank = seat_trim = carbon_fibre = exhaust = 0;
...
return n.join(".");
  ...
  $('.carbon_fibre .tot_amount').on('change',function(){
     $('.panel.carbon_fibre .tot_amount').not(this).prop('checked', false);     
   var carbon_fibre = [];     
