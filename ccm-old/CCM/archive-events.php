<?php
/**
    *   Template Name: Club CCM Events Archive
*
		...
		<section class="heading">	
			<div class="container tight width1116">
				...
				<div class="sub-content">
					<p>
						We have lots of great events that we hope to attend later in the year including The Goodwood Festival of Speed, The MCN Festival, Motorcycle Live once the current pandemic has passed, plus the opportunity to try out a new CCM on one of our Rideouts. Watch this space for the latest updates.
					</p>
				</div>
			</div>
		</section>
