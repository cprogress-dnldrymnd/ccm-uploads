                                                        ...
                                                        <div class="row flex-row">
                                                            <?php while ($the_query->have_posts()) { ?>
                                                                ...
                                                                <div class="col-md-3 col-sm-6 col-xs-6 mb-30 <?= $accessory_id ?>">
                                                                    <input name="<?= $section->slug ?>[]" class="tot_amount<?= $pre_selected . $required . $is_package . $exclude_from_deselection_val ?> " type="checkbox" id="<?= $accessory_id ?>" accesory_value="<?= $accessory_price ?>" value="<?= get_the_title() ?>" main_id="<?= 'box-' . $key ?>" <?= $related_products_val ?> sku="<?= clean_string_2($product->get_sku()) ?>">
