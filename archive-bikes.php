  ...
  <section class="hero-banner-with-breadcrumbs d-flex align-items-end ">
    <div class="video-holder">
      <?php if ($background_type == 'embed') { ?>
        <iframe class="<?= $background ? 'desktop-only' : '' ?>" frameborder="0" height="100%" width="100%"
        ...
        <?php if ($background) { ?>
          <?php if (strpos($mime_type, 'video') !== false) { ?>
            <video id="video" autoplay muted loop playsinline class="mobile-only" preload="metadata"
