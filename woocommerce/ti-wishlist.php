...
<div class="tinv-wishlist woocommerce tinv-wishlist-clear">
	<section class="wishlist-page sc-EHOje hIcROY">
		<section class="interaction-hero__wrapper">
			<section class="interaction-hero grid-x sc-gzVnrw kGwZFO">
				<div class="interaction-hero__single cell small-12 medium-6">
					<?php 
						$uploads = wp_upload_dir();	
						$upload_path = $uploads['baseurl'];	
					?>
					<img src="<?php echo $upload_path.'/ccm-logo-black.png' ?>" class="img-icon" />
					<p class="interaction-hero__description">Send your wishlist directly to CCM as an order form.</p>
					<a data-link="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" href="#" class="interaction-hero__link h6 text--orange slide-toggle-submit-order-frm">Submit Order<i class="fa fa-long-arrow-right"></i></a>
				</div>
				<div class="interaction-hero__single cell small-12 medium-6">
					<i class="fa fa-envelope" aria-hidden="true"></i>
					<p class="interaction-hero__description">Send your wishlist to the e-mail address of a friend.</p>
					<a data-link="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" href="#" class="interaction-hero__link h6 text--orange slide-toggle">Send link<i class="fa fa-long-arrow-right"></i></a>
				</div>
				<div class="interaction-hero__single cell small-12 medium-6">
					<i class="fa fa-file-pdf-o" aria-hidden="true"></i>
					<p class="interaction-hero__description">Save your wishlist as PDF.</p>
					<a href="#" class="interaction-hero__link h6 text--orange download_wishlist_pdf">Download PDF<i class="fa fa-long-arrow-right"></i></a>
				</div>
			</section>
		</section>
	</section>	
    <div class="box" id="wishlist_order" style="display: none;">
		<div class="box-inner-left"></div>
		<div class="box-inner-right">
			<div role="button" tabindex="-1" class="sidebar__close site-container--padded"><i class="fa fa-long-arrow-left"></i></div>
			<div class="email-share-code site-container--padded">
				<div><h3>submit order</h3></div>
				<p>SEND YOUR WISHLIST STRAIGHT TO CCM AND WE'LL BE IN TOUCH REGARDING YOUR ORDER</p>
				<?php echo do_shortcode('[contact-form-7 id="3989" title="WISHLIST SUBMIT BY ORDER"]'); ?>
			</div>
		</div>
	</div>
    <div class="box" id="wishlist_email" style="display: none;">
    	<div class="box-inner-left"></div>
        <div class="box-inner-right">
        <div role="button" tabindex="-1" class="sidebar__close site-container--padded"><i class="fa fa-long-arrow-left"></i></div>
        <div class="email-share-code site-container--padded">
        <div><h3>Send by email</h3></div>
        <p>SEND THE WISHLIST TO YOUR OWN EMAIL ADDRESS OR SHARE WITH A FRIEND</p>
        <?php echo do_shortcode('[contact-form-7 id="3534" title="WISHLIST SEND BY EMAIL"]'); ?>
        </div>
        </div>
    </div>
<script>
    jQuery(document).ready(function(){
		jQuery(".download_wishlist_pdf").click(function(e){
			e.preventDefault();
			document.location.href = '<?php echo get_home_url(); ?>/pdf.php';
		});
		jQuery(".text--orange.slide-toggle-submit-order-frm").click(function(e){
			e.preventDefault();	
			jQuery("#wishlist_order").animate({
				width: "toggle"
			});
			jQuery('.wpcf7-form-control-wrap input.whishlisturl ').attr('value', jQuery(this).attr('data-link'));
			jQuery("#wishlist_order").addClass("active");        
		});
		jQuery(".text--orange.slide-toggle").click(function(e){
			e.preventDefault();
			jQuery(".box").animate({
                width: "toggle"
            });
		...
		jQuery(".box .box-inner-left").click(function(e){
			e.preventDefault();
			jQuery(".box.active").animate({
                width: "toggle"
            });
			jQuery(".box").removeClass("active");
        });
		jQuery(".box .box-inner-right .sidebar__close").click(function(e){
			e.preventDefault();
			jQuery(".box.active").animate({
                width: "toggle"
            });
	...
	<?php //echo "<pre>"; print_r($wishlist); echo "</pre>"; ?>
